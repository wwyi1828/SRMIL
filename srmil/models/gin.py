...
class GIN(nn.Module):
    def __init__(self,
        ...
        if num_layers == 1:
            ...
            for l in range(1, num_layers - 1):
                ...
                self.mask_tokens.append(nn.Parameter(torch.randn(num_hidden)))
            # output projection
    ...
    def forward(self, g, inputs, return_hidden=False, mask_nodes=None):
        h = inputs.clone()
        hidden_list = []
        for l in range(self.num_layers):
            if (mask_nodes is not None):
                h[mask_nodes] = 0
                h[mask_nodes] += self.mask_tokens[l]
        ...
        if num_layers < 1:
            ...
            for layer in range(num_layers - 1):
                ...
                if norm_func is None:
                    ...
                    self.norms.append(norm_func(hidden_dim))
